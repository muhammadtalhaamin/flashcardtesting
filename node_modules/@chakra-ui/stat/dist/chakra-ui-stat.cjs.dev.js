...
const StatLabel = /*#__PURE__*/system.forwardRef((props, ref) => {
...
const StatHelpText = /*#__PURE__*/system.forwardRef((props, ref) => {
  const styles = system.useStyles();
...
const StatNumber = /*#__PURE__*/system.forwardRef((props, ref) => {
  const styles = system.useStyles();
  return /*#__PURE__*/React__namespace.createElement(system.chakra.dd, _extends({
    ref: ref
  }, props, {
...
const StatDownArrow = props => /*#__PURE__*/React__namespace.createElement(icon.Icon, _extends({
  color: "red.400"
...
const StatUpArrow = props => /*#__PURE__*/React__namespace.createElement(icon.Icon, _extends({
  color: "green.400"
}, props), /*#__PURE__*/React__namespace.createElement("path", {
  fill: "currentColor",
...
const Stat = /*#__PURE__*/system.forwardRef((props, ref) => {
  const styles = system.useMultiStyleConfig("Stat", props);
  const statStyles = {
    position: "relative",
    flex: "1 1 0%",
    ...styles.container
...
const StatGroup = /*#__PURE__*/system.forwardRef((props, ref) => /*#__PURE__*/React__namespace.createElement(system.chakra.div, _extends({}, props, {
  ref: ref,
  role: "group",
