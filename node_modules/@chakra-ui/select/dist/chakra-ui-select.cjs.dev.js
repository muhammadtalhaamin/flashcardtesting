...
const SelectField = /*#__PURE__*/system.forwardRef((props, ref) => {
  const {
    children,
    placeholder,
    className,
 ...
 */
const Select = /*#__PURE__*/system.forwardRef((props, ref) => {
  const styles = system.useMultiStyleConfig("Select", props);
  const {
    rootProps,
    placeholder,
    icon,
  ...
  const [layoutProps, otherProps] = utils.split(rest, system.layoutPropNames);
  const ownProps = formControl.useFormControl(otherProps);
  const rootStyles = {
    width: "100%",
    height: "fit-content",
    position: "relative",
  ...
  const fieldStyles = utils.mergeWith({
    paddingEnd: "2rem"
  }, styles.field, {
    _focus: {
      zIndex: "unset"
...
const DefaultIcon = props => /*#__PURE__*/React__namespace.createElement("svg", _extends({
  viewBox: "0 0 24 24"
}, props), /*#__PURE__*/React__namespace.createElement("path", {
  fill: "currentColor",
  d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"
}));
const IconWrapper = system.chakra("div", {
  baseStyle: {
    position: "absolute",
    display: "inline-flex",
    alignItems: "center",
...
const SelectIcon = props => {
  ...
  const clone = /*#__PURE__*/React__namespace.cloneElement(children, {
    role: "presentation",
