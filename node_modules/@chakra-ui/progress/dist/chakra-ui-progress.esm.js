...
const Circle = props => /*#__PURE__*/React.createElement(chakra.circle, _extends({
  cx: 50,
  cy: 50,
  r: 42,
  fill: "transparent"
...
const CircularProgress = props => {
  ...
  const strokeDasharray = isUndefined(determinant) ? undefined : `${determinant} ${264 - determinant}`;
