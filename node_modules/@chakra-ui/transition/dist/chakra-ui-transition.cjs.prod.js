...
const withDelay = {
  enter: (transition, delay) => ({ ...transition,
    delay: utils.isNumber(delay) ? delay : delay?.["enter"]
  }),
  exit: (transition, delay) => ({ ...transition,
    delay: utils.isNumber(delay) ? delay : delay?.["exit"]
  })
};
...
const Fade = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  const {
    unmountOnExit,
    in: isOpen,
    className,
...
const ScaleFade = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  const {
    unmountOnExit,
    in: isOpen,
    reverse = true,
...
const Slide = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  const {
    direction = "right",
    style,
    unmountOnExit,
...
const SlideFade = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  const {
    unmountOnExit,
    in: isOpen,
    reverse = true,
